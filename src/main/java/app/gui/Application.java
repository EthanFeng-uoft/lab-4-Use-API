...
public class Application {
    ...
    private static JPanel createManageTeamCard(JFrame jFrame, LeaveTeamUseCase leaveTeamUseCase,
        ...
        getTopButton.addActionListener(event -> {
            ...
            try {
                final float max = getTopGradeUseCase.getTopGrade(course);
                JOptionPane.showMessageDialog(jFrame, "Top Grade: " + max);
                courseField.setText("");
            }
            catch (Exception ex) {
                JOptionPane.showMessageDialog(jFrame, ex.getMessage());
        ...
        theCard.add(new JLabel("The course you want to calculate the team average/max for:"));
